...
namespace LibraryManagmentSystemIdentity.Data.Migrations
{
    ...
    [Migration("20250218132814_newData")]
            ...
            modelBuilder.Entity("LibraryManagmentSystemIdentity.Models.StudentBooksModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            StudentId = 1,
                            BookId = 1,
                            BorrowedDate = new DateTime(2025, 2, 18, 18, 58, 13, 403, DateTimeKind.Local).AddTicks(741),
                            ReturnDate = new DateTime(2025, 3, 4, 18, 58, 13, 403, DateTimeKind.Local).AddTicks(754)
                        });
                });
